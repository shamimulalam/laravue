...
return [
    ...
    */
    ...
    'max'                  => [
        'numeric' => ' :attribute এর মান :max এর চেয়ে ছোট হতে পারেনা।',
        'file'    => ':attribute এর মান :max কিলোবাইট এর চেয়ে ছোট হতে পারেনা।',
        'string'  => ':attribute এর মান :max অক্ষর এর চেয়ে ছোট হতে পারেনা।',
        'array'   => ':attribute এর মান :max টি উপাদানের চেয়ে ছোট হতে পারেনা।',
    ],
    'mimes'                => ':attribute এর একটি ফাইল হতে হবে: :values।',
    'mimetypes'            => ':attribute এর একটি ফাইল হতে হবে: :values।',
    'min'                  => [
        'numeric' => ':attribute অবশ্যই :min এর চেয়ে বড় হতে হবে।',
        'file'    => ':attribute অবশ্যই :min কিলোবাইট এর চেয়ে বড় হতে হবে।',
        'string'  => ':attribute অবশ্যই :min অক্ষর এর চেয়ে বড় হতে হবে।',
        'array'   => ':attribute অবশ্যই :min উপাদানের চেয়ে বড় হতে হবে।',
    ],
